...
public class Day18 implements Day<AdditionalInput> {

    public record AdditionalInput(Position start, Position end, int numberOfCorruptPositions) {
    }
    ...
    @Override
    public Long part1(List<String> inputLines, AdditionalInput additionalInput) {
