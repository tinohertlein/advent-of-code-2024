...
public class Day08Test {
    ...
    class Units {
        ...
        @Nested
        class CreateResonantHarmonicAntinodes {
    ...
    class Part1 {
        ...
        void sampleShouldBeSolved() {
            assertThat(day.part1(readSampleInputFor(day))).isEqualTo(14);
        }

        @ChallengeTest
        void challengeShouldBeSolved() {
            assertThat(day.part1(readChallengeInputFor(day))).isEqualTo(244);
        }
    }
    ...
    class Part2 {
        ...
        @Test
        void sampleShouldBeSolved() {
            assertThat(day.part2(readSampleInputFor(day))).isEqualTo(34);
        }

        @ChallengeTest
        void challengeShouldBeSolved() {
            assertThat(day.part2(readChallengeInputFor(day))).isEqualTo(912);
        }
    }
}
